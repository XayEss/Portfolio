...
<div id="sidebar">
	...
	<h2>Боковое меню</h2>
	<ul>
		<li><a href="products?category=raccoons">Еноты</a></li>
		<li><a href="products?category=pandas">Панды</a></li>
		<li><a href="products?category=ravens">Вороны</a></li>
		<li><a href="products?category=Magical Creatures">Магические
				существа</a></li>
